...
* Install Uniconfig (https://docs.frinx.io/frinx-odl-distribution/oxygen/getting-started.html)
* Install Postman (https://www.postman.com/downloads/)
* Import lab collection and environment settings file in Postman (https://github.com/FRINXio/Postman/tree/carbon/development/learning_labs/part1)
