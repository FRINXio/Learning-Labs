...
* To make your experience using Postman environment better, you can download Postman collection specifically made for this lab, in which you will find all the request you will need.
