...
In the Postman application, look at the left column and select the "Collections" tab, look up "Tests" and under the "IFC CRUD" folder, in "IFC-ACL CRUD Parts" folder find the "create acl ingress egress" PUT request.
